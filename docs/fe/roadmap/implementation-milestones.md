...
- [x] **4C.7. Pengaturan Lokasi Cabang, Geofence 100m, Jam Operasional & Mesin Kontingensi (`/admin/settings`)**
...
- [ ] **4C.8. Smart Absensi Geofencing + PIN 4-Digit (`/admin/attendance` & Workstation Clock-In)** (NEXT)
