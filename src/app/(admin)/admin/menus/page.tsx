...
export default function AdminMenusPage() {
  ...
  return (
    <div className="space-y-5 pb-16">
      ...
      {/* Filter Bar: Search, Sort Dropdown, Sort Order Button, Category Pills */}
      <MenuFilterBar
      ...
      {/* Desktop & Tablet Table View (>= 768px) with Sticky Column */}
      <MenuTable
        menus={menus}
        isLoading={isMenusLoading}
        isTogglePending={toggleMutation.isPending}
      ...
      {/* Reusable Shadcn-based Pagination Bar */}
      <Pagination
        page={meta.page}
        limit={meta.limit}
